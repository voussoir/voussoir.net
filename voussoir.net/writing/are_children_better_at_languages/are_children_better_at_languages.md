...
I am not a linguist nor a neuroscientist nor a psychologist. I didn't read any studies before writing this article and don't have any sources to cite. Sorry. The purpose of this article is [not to definitively answer the question](/writing/counter_counter_thoughts) but to exercise critical thinking in the face of Claims From The Internet. I am a layman on this topic and so are you [footnote_link]. Even if I read the neuroscience papers, I've heard too much about the flakiness and irreproducibility of psychological studies that I wouldn't actually feel any more confident. Purists will be annoyed that I can admit this and continue writing anyway. Such is the nature of understanding topics beyond my own expertise.
...
The problem is in the word "simple". If the question is "how do birds fly" then we could very simply answer it with "magic". In fact, that could cover just about anything we don't understand.

A better phrasing of Occam's razor is "one should prefer the explanation that makes the fewest assumptions". If we think that birds fly with magic, it makes a lot of assumptions: that magic exists, that birds have magic and we don't, and what's the deal with airplanes (hint: more magic). I also choose the word "prefer" because there's no need to pat myself on the back for having picked what's "probably correct" when the whole point is to objectively recognize what I know and don't.

When the question is "why is language learning easy for babies but hard for adults", then the answer of neuroplasticity starts to sound like magic, and there is not much in the way of quantifying the difference between child and adult neuroplasticity. It's just *enough* to explain away the question [footnote_link], but not too much or else adults would be totally incapable of learning.
...
[footnote_text] note I still haven't cited anything

## Advantages that children have over adults

### They don't really have a choice

Now, I'm not saying it's a matter of life and death like learning how to swim in the deep end (babies are notoriously bad at surviving on their own anyway), but you've got to admit there's an element of pressure for children to learn a first language. How else will they defy their parents or ask for cookies?

When I am reading or listening to something in Korean and I get frustrated or bored because I don't understand it, I can just turn it off and go do something else in English. Even in foreign language classes, where some teachers strive for 100% target language in the class at all times, of course peers will use English amongst each other, except maybe for the biggest nerds. Children don't really have those kinds of alternatives. Except crying I guess.

I read this comment recently and it stuck with me:
...
Do you really want to dump hundreds/thousands of hours into learning the foreign language, only to reach 'competence' when you could be developing your other skills into mastery? It's a hard sell.

My desire to learn Korean is purely interest-based, because I enjoy it, so I'm not worried about this part personally. I recognize that the situation is different for people learning English.

### Endless free time and constant immersion

Babies got nothing to do. No work, no school, no obligations whatsoever, [barely gettin' up to go potty](https://www.youtube.com/watch?v=4v34cgBnbfU). If I could sit around listening to my target language all day I'd progress a lot faster too.

There's not much detail to give here as I think it's pretty self-explanatory, but really these first two points account for a majority of the problem. An adult learner first has to subtract sleep and responsibilities from their allotted 24 hours, and with the remainder has to decide whether learning a new language is really important enough to give it up. Especially because spending X hours on something I'm bad at is tougher to do than spending the same X hours on something I'm already good at.
...
- use simple sentences and vocabulary (baby talk).
...
[MotivateKorean](http://youtube.com/channel/UCBpRNdkIp4LSUCgXOcp1NSQ) often says that when you're learning vocabulary, there is an important moment where you "make it yours". Discovering an opportunity to use a new word, and succesfully using it, hearing it come out of your own mouth, contributes much more to your learning than just doing flashcards. For children this will occur naturally and frequently. For adults, especially those learning on their own, it won't.

[footnote_text] You've probably seen Stephen Krashen demonstrate [comprehensible input](https://www.youtube.com/watch?v=fnUc_W3xE1w&t=3m20s). It's a good lesson, for sure, but in practicality it's extremely difficult to find material that matches your `i+1`. Partly because it's hard to define your current `i` in the first place. The parent-child relationship excels at this in a way that a language teacher / tutor / internet material simply can not. I have been listening to TTMIK's Iyagi since nearly the beginning, and although it is still above my skill level, I can feel that my comprehension has been going up. Don't get stuck in an endless search for the perfect `i+1` material, just find *something* that isn't impossible and get started.
...
When an adult learner starts texting or talking in their new language, they'd prefer to not make mistakes. Some are more embarrassed about mistakes than others, but I think it's true for all of us. I for one would rather forgo a thought than blunder it (I have the luxury of learning solely as a hobby with no real pressure or requirements for what to express). Of course, mistakes can be very productive because you can get feedback instantly and in context which are pretty much the two best things for feedback to be. It's just very difficult to overcome the pride. See also the previous point about how nobody wants to listen to you stumbling all the time and suddenly I'm even more self-conscious about opening my mouth.
...
When a very young child is learning their first language, they accumulate vocabulary mostly according to the whims of the world around them: what their family talks about, what's on TV. An older child can [pick out books](https://www.youtube.com/watch?v=hvrnKrZiqPE) but will have difficulty really searching for something. The older you get, the more accurately you can search the internet, pick materials for your skill level, ask (well-formed, please!) questions on forums, etc.
...
## This isn't a defeatist piece

If you're keeping score, you may feel like overall the kids come out on top. Even if an actively studying adult can outpace a child's language learning, the amount of effort and difficulty in reaching fluency makes it feel like more of a slog. However, I think that negative feeling would be even more amplified if we were to concede that children just have special plasticy brains and they have the biological advantage and there's nothing we can do about that. Now that I've given my reasons for not believing in that as a primary cause, we can find some actionable takeaways by applying babys' strategies to our own learning.
...
- **They don't really have a choice** --> An adult learner should also strive to remove their choices. Stop fleeing back to the English safe zone. Change the language of your phone or computer. This is why  Matt vs. Japan calls it the mass immersion approach.
  ...
  This isn't always conducive to the best work/life/responsibilities balance, but babies don't really have those things. Just try to get as close as you can.
...
[footnote_text] I switched from Google Play Music because I couldn't switch domains like this without throwing away the current queue. It's not the same as a playlist because queues need to maintain your track position and be easy to edit. Also GPM kept asking me to pay for a subscription.
